...
- 当前阶段：前端课程详情页任务管理闭环已完成，下一阶段进入课程管理前端开发。
...
- 前端认证、课程列表首页、课程详情查询和任务管理闭环均已完成。
- 下一阶段进入课程创建、编辑和删除的前端闭环开发。

## 本次更新

- 同步课程详情页任务查询、新建、展开、状态切换、编辑和删除的真实进度。
- 记录任务管理完整浏览器 Network 联调以及各阶段 lint、生产构建通过结果。
- 将下一阶段调整为课程管理前端开发。
...
1. 优先完成首页新建课程前端闭环。
2. 再分别完成课程编辑和课程删除前端闭环，不扩大到其他功能。
3. 每个闭环完成后运行 lint、生产构建，并使用浏览器 Network 做真实联调。
